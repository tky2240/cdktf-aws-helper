...
declare module "@cdktf/provider-aws/lib/fsx-ontap-file-system" {
  interface FsxOntapFileSystem extends ILinkable {}
}
...
Object.setPrototypeOf(FsxOntapFileSystem, OriginalFsxOntapFileSystem);
